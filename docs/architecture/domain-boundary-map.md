...
| `ServiceCatalog` | the catalog of LGU services offered; assistance **programmes**, their requirement templates and their eligibility guidance | applications submitted against a service or programme (asks `Welfare`); who a person *is* (asks `ResidentProfile`); any determination of eligibility — the guidance advises and never decides (ADR 0018 §3) | **implemented** (reference vertical; programmes TAB 13) |
