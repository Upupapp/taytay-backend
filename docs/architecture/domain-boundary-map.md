...
| `Welfare` | social welfare cases: the canonical lifecycle, transitions, assignment, priority and the case timeline | who a person *is* (asks `ResidentProfile`), eligibility decisions derived from a vulnerability score (ADR 0016 §4), money movement (TAB 18) | **implemented** (TAB 11) |
