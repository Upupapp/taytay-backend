...
| `ResidentProfile` | resident master record, demographics, addresses, verification tier, KYC cases, change history and aliases, duplicate pairs and merges, correction requests, account→resident links, households, families, effective-dated membership, kinship | login credentials, issued ID cards | **implemented** (TAB 06, TAB 08, TAB 09) |
